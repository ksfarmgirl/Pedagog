...
<p>This tool helps you learn Python, JavaScript, C, C++,
and Java programming by <a href="visualize.html">visualizing code execution</a>. You can use it to debug your
homework assignments and as a supplement to online coding tutorials.</p>

<div id="startLink">
Start coding now in <a href="python-debugger.html"><b>Python</b></a>, <a href="javascript.html"><b>JavaScript</b></a>, <a href="c.html"><b>C</b></a>, <a href="cpp.html"><b>C++</b></a>, and <a href="java.html"><b>Java</b></a>

</div>

<p><b>Over 15 million people in more than 180 countries</b> have used
Python Tutor to visualize over 200 million pieces of code. It is the most
widely-used program visualization tool for computing education.</p>

<p>You can also embed these visualizations into any webpage. Here's an
example showing recursion in Python:</p>

<div id="demoViz"><div class="ExecutionVisualizer"><table border="0" class="visualizer"><tbody><tr>                           <td class="vizLayoutTd" id="vizLayoutTdFirst"><div id="codAndNav" style="width: 350px;" class="ui-resizable"><div id="codeDisplayDiv">         <div id="langDisplayDiv">Python 3.6</div>         <div id="pyCodeOutputDiv" style="max-height: 400px;"><table id="pyCodeOutput"><tr><td id="gutterTD" valign="top" rowspan="9"><svg id="leftCodeGutterSVG" style="height: 195.775px;"><polygon id="prevLineArrow" points="0,3 12,3 12,0 18,5 12,10 12,7 0,7" fill="#c9e6ca" transform="translate(0, 91.9000244140625)"></polygon><polygon id="curLineArrow" points="0,3 12,3 12,0 18,5 12,10 12,7 0,7" fill="#e93f34" transform="translate(0, 113.87503051757812)"></polygon></svg></td><td class="lineNo" id="lineNo1" style="cursor: pointer;">1</td><td class="cod" id="v1__cod1" style="cursor: pointer;">def&nbsp;listSum(numbers):</td></tr><tr><td class="lineNo" id="lineNo2" style="cursor: pointer;">2</td><td class="cod" id="v1__cod2" style="cursor: pointer;">&nbsp;&nbsp;if&nbsp;not&nbsp;numbers:</td></tr><tr><td class="lineNo" id="lineNo3" style="cursor: pointer;">3</td><td class="cod" id="v1__cod3" style="cursor: pointer;">&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;0</td></tr><tr><td class="lineNo" id="lineNo4">4</td><td class="cod" id="v1__cod4">&nbsp;&nbsp;else:</td></tr><tr><td class="lineNo" id="lineNo5" style="cursor: pointer;">5</td><td class="cod" id="v1__cod5" style="cursor: pointer;">&nbsp;&nbsp;&nbsp;&nbsp;(f,&nbsp;rest)&nbsp;=&nbsp;numbers</td></tr><tr><td class="lineNo" id="lineNo6" style="cursor: pointer;">6</td><td class="cod" id="v1__cod6" style="cursor: pointer;">&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;f&nbsp;+&nbsp;listSum(rest)</td></tr><tr><td class="lineNo" id="lineNo7">7</td><td class="cod" id="v1__cod7"></td></tr><tr><td class="lineNo" id="lineNo8" style="cursor: pointer;">8</td><td class="cod" id="v1__cod8" style="cursor: pointer;">myList&nbsp;=&nbsp;(1,&nbsp;(2,&nbsp;(3,&nbsp;None)))</td></tr><tr><td class="lineNo" id="lineNo9" style="cursor: pointer;">9</td><td class="cod" id="v1__cod9" style="cursor: pointer;">total&nbsp;=&nbsp;listSum(myList)</td></tr></table></div>         <div id="editCodeLinkDiv"><a id="editBtn" href="https://pythontutor.com/visualize.html#code=def%20listSum(numbers)%3A%0A%20%20if%20not%20numbers%3A%0A%20%20%20%20return%200%0A%20%20else%3A%0A%20%20%20%20(f,%20rest)%20%3D%20numbers%0A%20%20%20%20return%20f%20%2B%20listSum(rest)%0A%0AmyList%20%3D%20(1,%20(2,%20(3,%20None)))%0Atotal%20%3D%20listSum(myList)&amp;py=3" target="_blank">Edit this code</a>         </div>         <div id="legendDiv"><svg id="prevLegendArrowSVG"><polygon points="0,3 12,3 12,0 18,5 12,10 12,7 0,7" fill="#c9e6ca"></polygon></svg> line that just executed<p style="margin-top: 4px"><svg id="curLegendArrowSVG"><polygon points="0,3 12,3 12,0 18,5 12,10 12,7 0,7" fill="#e93f34"></polygon></svg> next line to execute</p></div>         <div id="codeFooterDocs" style="display: none;"></div>       </div><div id="navControlsDiv">                     <div id="executionSlider" class="ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" style="font-size: 0.9em;"><span class="ui-slider-handle ui-state-default ui-corner-all" tabindex="0" style="left: 45.4545%; width: 0.8em; height: 1.4em;"></span></div>                     <div id="executionSliderFooter"></div>                     <div id="vcrControls">                       <button id="jmpFirstInstr" ,="" type="button" style="display: none;">&lt;&lt; First</button>                       <button id="jmpStepBack" ,="" type="button">&lt; Prev</button>                       <button id="jmpStepFwd" ,="" type="button">Next &gt;</button>                       <button id="jmpLastInstr" ,="" type="button" style="display: none;">Last &gt;&gt;</button>                     </div>                     <div id="curInstr">Step 11 of 22</div><!-- update #curInstr in setVcrControls() later -->                     <div id="rawUserInputDiv" style="display: none;"><!-- hide rawUserInputDiv initially -->                       <span id="userInputPromptStr"></span>                       <input type="text" id="raw_input_textbox" size="30">                       <button id="raw_input_submit_btn">Submit</button>                     </div>                     <div id="errorOutput" style="display: none;"></div>                     <div id="warningsOutput" style="display: none;"></div>                     <div id="creditsPane">Visualized with <a href="https://pythontutor.com/visualize.html" target="_blank">pythontutor.com</a>
      <br><br>
      <font color="#e93f34">NEW:</font> <a href="https://www.youtube.com/@python-tutor" target="_blank">subscribe</a> to our YouTube
    </div>                     <div id="uiControlsPane">                      <a id="customizeVizLink" href="#">Move and hide objects</a>                     </div>                   </div><div class="ui-resizable-handle ui-resizable-e" style="z-index: 90;"></div></div></td>                           <td class="vizLayoutTd" id="vizLayoutTdSecond"><div id="progOutputs" style="display: none;">         <div id="printOutputDocs">Print output (drag lower right corner to resize)</div>
         <div class="ui-wrapper" style="overflow: hidden; position: relative; width: 357.6px; height: 52.6px; top: 0px; left: 0px; margin: 0px; padding-right: 5.8px; padding-bottom: 16px;"><textarea id="pyStdout" cols="40" rows="5" wrap="off" readonly="" class="ui-resizable" style="width: 351.6px; height: 46.6px; margin: 0px; resize: none; position: static; zoom: 1; display: block;"></textarea><div class="ui-resizable-handle ui-resizable-e" style="z-index: 90;"></div><div class="ui-resizable-handle ui-resizable-s" style="z-index: 90;"></div><div class="ui-resizable-handle ui-resizable-se ui-icon ui-icon-gripsmall-diagonal-se" style="z-index: 90;"></div></div>       </div>
      <div id="dataViz">
         <table id="stackHeapTable">
           <tbody><tr>
             <td id="stack_td">
               ...
               <div class="stackFrame" id="v1__globals"><div id="v1__globals_header" class="stackFrameHeader">Global frame</div><table class="stackFrameVarTable" id="v1__global_table"><tr class="variableTr" id="v1__global__listSum_tr"><td class="stackFrameVar">listSum</td><td class="stackFrameValue"><div class="stack_pointer" id="v1__global__listSum">&nbsp;</div></td></tr><tr class="variableTr" id="v1__global__myList_tr"><td class="stackFrameVar">myList</td><td class="stackFrameValue"><div class="stack_pointer" id="v1__global__myList">&nbsp;</div></td></tr></table></div></div>
               <div id="stack"><div class="stackFrame" id="v1__stack0" data-frame_id="1"><div class="stackFrameHeader">listSum</div><table class="stackFrameVarTable"><tr class="variableTr" id="v1__listSum_f1__numbers_tr"><td class="stackFrameVar">numbers</td><td class="stackFrameValue"><div class="stack_pointer" id="v1__listSum_f1__numbers">&nbsp;</div></td></tr><tr class="variableTr" id="v1__listSum_f1__f_tr"><td class="stackFrameVar">f</td><td class="stackFrameValue"><span class="numberObj">1</span></td></tr><tr class="variableTr" id="v1__listSum_f1__rest_tr"><td class="stackFrameVar">rest</td><td class="stackFrameValue"><div class="stack_pointer" id="v1__listSum_f1__rest">&nbsp;</div></td></tr></table></div><div class="stackFrame highlightedStackFrame" id="v1__stack1" data-frame_id="2"><div class="stackFrameHeader">listSum</div><table class="stackFrameVarTable"><tr class="variableTr" id="v1__listSum_f2__numbers_tr"><td class="stackFrameVar">numbers</td><td class="stackFrameValue"><div class="stack_pointer" id="v1__listSum_f2__numbers">&nbsp;</div></td></tr><tr class="variableTr" id="v1__listSum_f2__f_tr"><td class="stackFrameVar">f</td><td class="stackFrameValue"><span class="numberObj">2</span></td></tr><tr class="variableTr" id="v1__listSum_f2__rest_tr"><td class="stackFrameVar">rest</td><td class="stackFrameValue"><div class="stack_pointer" id="v1__listSum_f2__rest">&nbsp;</div></td></tr></table></div></div>
             </td>
             <td id="heap_td">
               <div id="heap"><div id="heapHeader">Objects</div><table id="heapRow0" class="heapRow"><td class="toplevelHeapObject" id="toplevel_heap_object_1"><div class="heapObject" id="v1__heap_object_1"><div class="typeLabel">function</div><div class="funcObj"> listSum(numbers)</div></div></td></table><table id="heapRow1" class="heapRow"><td class="toplevelHeapObject" id="toplevel_heap_object_2"><div class="heapObject" id="v1__heap_object_2"><div class="typeLabel">tuple</div><table class="tupleTbl"><tr><td class="tupleHeader">0</td><td class="tupleHeader">1</td></tr><tr><td class="tupleElt"><span class="numberObj">1</span></td><td class="tupleElt"><div id="v1__heap_pointer_src_1">&nbsp;</div></td></tr></table></div></td><td class="toplevelHeapObject" id="toplevel_heap_object_3"><div class="heapObject" id="v1__heap_object_3"><div class="typeLabel">tuple</div><table class="tupleTbl"><tr><td class="tupleHeader">0</td><td class="tupleHeader">1</td></tr><tr><td class="tupleElt"><span class="numberObj">2</span></td><td class="tupleElt"><div id="v1__heap_pointer_src_2">&nbsp;</div></td></tr></table></div></td><td class="toplevelHeapObject" id="toplevel_heap_object_4"><div class="heapObject" id="v1__heap_object_4"><div class="typeLabel">tuple</div><table class="tupleTbl"><tr><td class="tupleHeader">0</td><td class="tupleHeader">1</td></tr><tr><td class="tupleElt"><span class="numberObj">3</span></td><td class="tupleElt"><span class="nullObj">None</span></td></tr></table></div></td></table></div>
             </td>
           </tr>
         </tbody></table>
      </div>
      ...
      <div id="cppDetailPane"></div>
       <div class="_jsPlumb_endpoint  ui-draggable ui-draggable-handle ui-droppable" style="position: absolute; height: 6px; width: 6px; left: 651.3px; top: 473.2px;"><svg style="position:absolute;left:0px;top:0px" width="6" height="6" pointer-events="all" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml"><circle cx="3" cy="3" r="3" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="#005583" stroke="none"></circle></svg></div><div class="_jsPlumb_endpoint  ui-draggable ui-draggable-handle ui-droppable" style="position: absolute; height: 6px; width: 6px; left: 679.7px; top: 460.9px;"><svg style="position:absolute;left:0px;top:0px" width="6" height="6" pointer-events="all" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml"><circle cx="3" cy="3" r="3" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="none" stroke="none"></circle></svg></div><svg style="position:absolute;left:641.5199768066407px;top:458.36502161026px" width="53.960046386718744" height="23.36998767852783" pointer-events="none" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml" class="_jsPlumb_connector "><path d="M 12.780010986328126 17.834990596771238 C 26.980023193359372 11.684993839263916 26.980023193359372 11.684993839263916 41.18003540039062 5.534997081756592" pointer-events="all" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="none" stroke="#005583" stroke-width="1"></path><path pointer-events="all" version="1.1" xmlns="http://www.w3.org/1999/xhtml" d="M41.18003540039062,5.534997081756592 L33.40997190910063,12.737504516068789 L36.137703461580294,7.731559992044685 L30.614346386915784,6.3199911394011 L41.18003540039062,5.534997081756592" class="" stroke="#005583" fill="#005583"></path></svg><div class="_jsPlumb_endpoint  ui-draggable ui-draggable-handle ui-droppable" style="position: absolute; height: 6px; width: 6px; left: 726.463px; top: 473.2px;"><svg style="position:absolute;left:0px;top:0px" width="6" height="6" pointer-events="all" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml"><circle cx="3" cy="3" r="3" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="#005583" stroke="none"></circle></svg></div><div class="_jsPlumb_endpoint  ui-draggable ui-draggable-handle ui-droppable" style="position: absolute; height: 6px; width: 6px; left: 754.862px; top: 460.9px;"><svg style="position:absolute;left:0px;top:0px" width="6" height="6" pointer-events="all" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml"><circle cx="3" cy="3" r="3" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="none" stroke="none"></circle></svg></div><svg style="position:absolute;left:716.6825408935547px;top:458.36502161026px" width="53.959930419921875" height="23.36998767852783" pointer-events="none" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml" class="_jsPlumb_connector "><path d="M 12.779983520507812 17.834990596771238 C 26.979965209960938 11.684993839263916 26.979965209960938 11.684993839263916 41.17994689941406 5.534997081756592" pointer-events="all" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="none" stroke="#005583" stroke-width="1"></path><path pointer-events="all" version="1.1" xmlns="http://www.w3.org/1999/xhtml" d="M41.17994689941406,5.534997081756592 L33.40988908567033,12.737510640999638 L36.137616692097055,7.731563966779316 L30.61425850473232,6.319999468050721 L41.17994689941406,5.534997081756592" class="" stroke="#005583" fill="#005583"></path></svg><div class="_jsPlumb_endpoint  ui-draggable ui-draggable-handle ui-droppable" style="position: absolute; height: 6px; width: 6px; left: 522.737px; top: 414.8px;"><svg style="position:absolute;left:0px;top:0px" width="6" height="6" pointer-events="all" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml"><circle cx="3" cy="3" r="3" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="#cccccc" stroke="none"></circle></svg></div><div class="_jsPlumb_endpoint  ui-draggable ui-draggable-handle ui-droppable" style="position: absolute; height: 6px; width: 6px; left: 604.538px; top: 395.6px;"><svg style="position:absolute;left:0px;top:0px" width="6" height="6" pointer-events="all" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml"><circle cx="3" cy="3" r="3" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="none" stroke="none"></circle></svg></div><svg style="position:absolute;left:488.9274658203125px;top:378.8000030517578px" width="155.4200927734375" height="58.800018310546875" pointer-events="none" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml" class="_jsPlumb_connector "><path d="M 36.81002197265625 39.00001525878906 C 67.71004638671874 19.400009155273438 67.71004638671874 19.400009155273438 118.61007080078124 19.800003051757812" pointer-events="all" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="none" stroke="#cccccc" stroke-width="1"></path><path pointer-events="all" version="1.1" xmlns="http://www.w3.org/1999/xhtml" d="M118.61007080078124,19.800003051757812 L108.6371388590051,16.223604236650466 L113.11023174520437,19.757927372900678 L108.58358799500512,23.223399398293758 L118.61007080078124,19.800003051757812" class="" stroke="#cccccc" fill="#cccccc"></path></svg><div class="_jsPlumb_endpoint  ui-draggable ui-draggable-handle ui-droppable" style="position: absolute; height: 6px; width: 6px; left: 522.737px; top: 439.2px;"><svg style="position:absolute;left:0px;top:0px" width="6" height="6" pointer-events="all" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml"><circle cx="3" cy="3" r="3" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="#cccccc" stroke="none"></circle></svg></div><div class="_jsPlumb_endpoint  ui-draggable ui-draggable-handle ui-droppable" style="position: absolute; height: 6px; width: 6px; left: 604.538px; top: 460.9px;"><svg style="position:absolute;left:0px;top:0px" width="6" height="6" pointer-events="all" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml"><circle cx="3" cy="3" r="3" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="none" stroke="none"></circle></svg></div><svg style="position:absolute;left:488.9274658203125px;top:421.7750105857849px" width="155.4200927734375" height="62.55000972747801" pointer-events="none" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml" class="_jsPlumb_connector "><path d="M 36.81002197265625 20.42500162124633 C 87.71004638671874 21.275004863739007 87.71004638671874 21.275004863739007 118.61007080078124 42.125008106231675" pointer-events="all" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="none" stroke="#cccccc" stroke-width="1"></path><path pointer-events="all" version="1.1" xmlns="http://www.w3.org/1999/xhtml" d="M118.61007080078124,42.125008106231675 L112.27749221900098,33.630983824092034 L114.05058938047743,39.04911324816121 L108.3627169450931,39.43396017720598 L118.61007080078124,42.125008106231675" class="" stroke="#cccccc" fill="#cccccc"></path></svg><div class="_jsPlumb_endpoint  ui-draggable ui-draggable-handle ui-droppable" style="position: absolute; height: 6px; width: 6px; left: 522.738px; top: 511.4px;"><svg style="position:absolute;left:0px;top:0px" width="6" height="6" pointer-events="all" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml"><circle cx="3" cy="3" r="3" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="#cccccc" stroke="none"></circle></svg></div><div class="_jsPlumb_endpoint  ui-draggable ui-draggable-handle ui-droppable" style="position: absolute; height: 6px; width: 6px; left: 604.538px; top: 460.9px;"><svg style="position:absolute;left:0px;top:0px" width="6" height="6" pointer-events="all" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml"><circle cx="3" cy="3" r="3" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="none" stroke="none"></circle></svg></div><svg style="position:absolute;left:488.92750177383425px;top:436.2750248908997px" width="155.42004566192625" height="105.74996280670163" pointer-events="none" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml" class="_jsPlumb_connector "><path d="M 36.81001081466675 78.12496900558469 C 67.71002283096313 42.874981403350816 67.71002283096313 42.874981403350816 118.6100348472595 27.624993801116933" pointer-events="all" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="none" stroke="#cccccc" stroke-width="1"></path><path pointer-events="all" version="1.1" xmlns="http://www.w3.org/1999/xhtml" d="M118.6100348472595,27.624993801116933 L110.03680030178585,33.84991544145081 L113.34181532318397,29.20482386987413 L108.02610748700396,27.144908774445586 L118.6100348472595,27.624993801116933" class="" stroke="#cccccc" fill="#cccccc"></path></svg><div class="_jsPlumb_endpoint  ui-draggable ui-draggable-handle ui-droppable" style="position: absolute; height: 6px; width: 6px; left: 522.738px; top: 560.2px;"><svg style="position:absolute;left:0px;top:0px" width="6" height="6" pointer-events="all" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml"><circle cx="3" cy="3" r="3" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="#cccccc" stroke="none"></circle></svg></div><div class="_jsPlumb_endpoint  ui-draggable ui-draggable-handle ui-droppable" style="position: absolute; height: 6px; width: 6px; left: 679.7px; top: 460.9px;"><svg style="position:absolute;left:0px;top:0px" width="6" height="6" pointer-events="all" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml"><circle cx="3" cy="3" r="3" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="none" stroke="none"></circle></svg></div><svg style="position:absolute;left:455.10438776016235px;top:419.21502161026px" width="298.2287492752075" height="188.66998767852783" pointer-events="none" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml" class="_jsPlumb_connector "><path d="M 70.63312482833862 143.98499059677124 C 139.11437463760376 84.33499383926392 139.11437463760376 84.33499383926392 227.5956244468689 44.68499708175659" pointer-events="all" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="none" stroke="#cccccc" stroke-width="1"></path><path pointer-events="all" version="1.1" xmlns="http://www.w3.org/1999/xhtml" d="M227.5956244468689,44.68499708175659 L219.90177934599075,51.96886607863546 L222.57668494808746,46.934496205466466 L217.03878046126908,45.581124898368174 L227.5956244468689,44.68499708175659" class="" stroke="#cccccc" fill="#cccccc"></path></svg><div class="_jsPlumb_endpoint  ui-draggable ui-draggable-handle ui-droppable" style="position: absolute; height: 6px; width: 6px; left: 522.738px; top: 632.4px;"><svg style="position:absolute;left:0px;top:0px" width="6" height="6" pointer-events="all" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml"><circle cx="3" cy="3" r="3" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="#005583" stroke="none"></circle></svg></div><div class="_jsPlumb_endpoint  ui-draggable ui-draggable-handle ui-droppable" style="position: absolute; height: 6px; width: 6px; left: 679.7px; top: 460.9px;"><svg style="position:absolute;left:0px;top:0px" width="6" height="6" pointer-events="all" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml"><circle cx="3" cy="3" r="3" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="none" stroke="none"></circle></svg></div><svg style="position:absolute;left:455.10438776016235px;top:386.72501611709595px" width="298.2287492752075" height="325.8500108718872" pointer-events="none" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml" class="_jsPlumb_connector "><path d="M 70.63312482833862 248.67500829696655 C 139.11437463760376 152.9250054359436 139.11437463760376 152.9250054359436 227.5956244468689 77.17500257492065" pointer-events="all" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="none" stroke="#005583" stroke-width="1"></path><path pointer-events="all" version="1.1" xmlns="http://www.w3.org/1999/xhtml" d="M227.5956244468689,77.17500257492065 L222.27596151004212,86.33749056883104 L223.41781281739677,80.75213690125612 L217.7232450947061,81.0202757676847 L227.5956244468689,77.17500257492065" class="" stroke="#005583" fill="#005583"></path></svg><div class="_jsPlumb_endpoint  ui-draggable ui-draggable-handle ui-droppable" style="position: absolute; height: 6px; width: 6px; left: 522.738px; top: 681.2px;"><svg style="position:absolute;left:0px;top:0px" width="6" height="6" pointer-events="all" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml"><circle cx="3" cy="3" r="3" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="#005583" stroke="none"></circle></svg></div><div class="_jsPlumb_endpoint  ui-draggable ui-draggable-handle ui-droppable" style="position: absolute; height: 6px; width: 6px; left: 754.862px; top: 460.9px;"><svg style="position:absolute;left:0px;top:0px" width="6" height="6" pointer-events="all" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml"><circle cx="3" cy="3" r="3" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="none" stroke="none"></circle></svg></div><svg style="position:absolute;left:421.28127374649046px;top:364.76502161026px" width="441.03745288848876" height="418.5699876785278" pointer-events="none" position="absolute" version="1.1" xmlns="http://www.w3.org/1999/xhtml" class="_jsPlumb_connector "><path d="M 104.4562388420105 319.43499059677123 C 210.51872644424438 199.2849938392639 210.51872644424438 199.2849938392639 336.58121404647824 99.1349970817566" pointer-events="all" version="1.1" xmlns="http://www.w3.org/1999/xhtml" style="" fill="none" stroke="#005583" stroke-width="1"></path><path pointer-events="all" version="1.1" xmlns="http://www.w3.org/1999/xhtml" d="M336.58121404647824,99.1349970817566 L330.92890805463134,108.09610398740904 L332.27495001542803,102.55641346899786 L326.5743781072334,102.61540431152693 L336.58121404647824,99.1349970817566" class="" stroke="#005583" fill="#005583"></path></svg></td>                         </tr></tbody></table></div></div>
